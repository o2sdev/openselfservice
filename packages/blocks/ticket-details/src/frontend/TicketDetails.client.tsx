...
export const TicketDetailsPure = ({ locale, accessToken, routing, ...component }: Readonly<TicketDetailsPureProps>) => {
        ...
        <div className="w-full">
            <div className="flex flex-col gap-6">
                <div className="flex gap-2 sm:gap-4 flex-col sm:flex-row flex-wrap">
                    ...
                    <div>
                        <Badge variant={Mappings.TicketBadge.ticketBadgeVariants[ticket.status.value]}>
                            {ticket.status.label}
                        </Badge>
                    </div>
                </div>
