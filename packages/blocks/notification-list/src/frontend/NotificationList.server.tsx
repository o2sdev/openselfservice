...
export const NotificationListServer: React.FC<NotificationListProps> = async ({ id, accessToken, locale, routing }) => {
    try {
        ...
        return (
            <NotificationListDynamic {...data} id={id} accessToken={accessToken} locale={locale} routing={routing} />
        );
    } catch (_error) {
        return null;
    }
