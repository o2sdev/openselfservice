...
- **View this block in Storybook**: [order-list](https://storybook-o2s.openselfservice.com/?path=/story/blocks-orderlist--default)
...
```bash
npm install @o2s/blocks.order-list
```
...
```typescript
import { getSdk } from '@o2s/blocks.order-list/sdk';
