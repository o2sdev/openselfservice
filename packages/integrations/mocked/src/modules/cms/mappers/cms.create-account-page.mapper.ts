...
const CREATE_ACCOUNT_PL: CMS.Model.CreateAccountPage.CreateAccountPage = {
    ...
    step1Subtitle: 'Wprowadź NIP firmy i username poniżej, aby utworzyć konto.',
    step1SubmitButton: 'Kontynuuj',
    step2Title: 'Utwórz konto',
    step2Subtitle: 'Wypełnij pozostałe dane, aby utworzyć swoje konto.',
    step2SubmitButton: 'Zarejestruj się',
...
const CREATE_ACCOUNT_EN: CMS.Model.CreateAccountPage.CreateAccountPage = {
    ...
    step1Subtitle: 'Please enter your company Tax ID, and username below to create an account.',
    step1SubmitButton: 'Continue',
    step2Title: 'Create an account',
    step2Subtitle: 'Fill in the remaining details to create your account.',
    step2SubmitButton: 'Sign up',
...
const CREATE_ACCOUNT_DE: CMS.Model.CreateAccountPage.CreateAccountPage = {
    ...
    clientId: {
        ...
        label: 'Kunden-ID',
        placeholder: '1298001',
        description: 'Finden Sie die Kunden-ID, z.B. auf der Rechnung. Die zugehörige Telefonnummer: +49 ****** 1432',
        errorMessages: [
            {
                type: 'required',
    ...
    step1Subtitle: 'Geben Sie die Steuer-ID Ihres Unternehmens und Ihre E-Mail unten ein, um ein Konto zu erstellen.',
    step1SubmitButton: 'Weiter',
    step2Title: 'Konto erstellen',
    step2Subtitle: 'Füllen Sie die restlichen Details aus, um Ihr Konto zu erstellen.',
    step2SubmitButton: 'Registrieren',
    signInTitle: 'Haben Sie bereits ein Konto?',
    signInButton: {
        label: 'Anmelden',
        link: '/de/anmelden',
    },
