...
const MOCK_SURVEY_1: CMS.Model.SurveyComponent.SurveyComponent = {
    code: 'survey-1',
...
const MOCK_SURVEY_2: CMS.Model.SurveyComponent.SurveyComponent = {
    code: 'survey-2',
...
export const mapSurveyComponent = (id: string): CMS.Model.SurveyComponent.SurveyComponent => {
    return MOCK_SURVEYS.find((survey) => survey.code === id) ?? MOCK_SURVEY_1;
};
