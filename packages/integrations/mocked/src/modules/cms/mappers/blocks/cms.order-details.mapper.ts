        ...
        items: [
            {
                ...
                options: [
                    ...
                    { label: 'Net value (ascending)', value: 'subtotal_ASC' },
                    { label: 'Net value (descending)', value: 'subtotal_DESC' },
        ...
        items: [
            {
                ...
                options: [
                    ...
                    { label: 'Nettobetrag (aufsteigend)', value: 'subtotal_ASC' },
                    { label: 'Nettobetrag (absteigend)', value: 'subtotal_DESC' },
...
const MOCK_ORDER_DETAILS_BLOCK_PL: CMS.Model.OrderDetailsBlock.OrderDetailsBlock = {
    ...
    table: {
        columns: [
            ...
            { id: 'subtotal', title: 'Wartość netto' },
        ],
    },
    filters: {
        ...
        items: [
            {
                ...
                options: [
                    ...
                    { label: 'Wartość netto (rosnąco)', value: 'subtotal_ASC' },
                    { label: 'Wartość netto (malejąco)', value: 'subtotal_DESC' },
