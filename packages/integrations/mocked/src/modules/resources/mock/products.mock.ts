...
// Base product data without localized links
...
// Create localized versions with appropriate links
export const MOCK_PRODUCTS_EN: Products.Model.Product[] = MOCK_PRODUCTS_BASE.map((product) => ({
    ...product,
    link: `/products/${product.id}`,
}));

export const MOCK_PRODUCTS_DE: Products.Model.Product[] = MOCK_PRODUCTS_BASE.map((product) => ({
    ...product,
    link: `/produkte/${product.id}`,
}));

export const MOCK_PRODUCTS_PL: Products.Model.Product[] = MOCK_PRODUCTS_BASE.map((product) => ({
    ...product,
    link: `/produkty/${product.id}`,
}));
