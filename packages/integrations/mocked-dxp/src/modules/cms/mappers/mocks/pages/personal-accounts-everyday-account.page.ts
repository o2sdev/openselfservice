...
export const personalAccountsEverydayAccountPage = CMS.Pages.definePage({
    id: 'personal-accounts-everyday-account-1',
    parent: personalAccountsPage,
    hasOwnTitle: true,
    theme: 'personal',
    locales: {
        en: { slug: '/personal/accounts/everyday-account', seo: { title: 'Everyday Account' } },
        pl: { slug: '/indywidualny/konta/konto-codzienne', seo: { title: 'Konto Codzienne' } },
        de: { slug: '/personlich/konten/tageskonto', seo: { title: 'Tageskonto' } },
    },
    template: {
