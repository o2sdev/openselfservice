...
const badgeStatusVariants = cva(
    'inline-flex items-center rounded-full w-2 h-2 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
    {
        variants: {
            variant: {
