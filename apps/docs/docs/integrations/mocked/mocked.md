...
This integration is automatically installed when you bootstrap a new portal with `npx create-o2s-app my-portal`. If you need to install it manually in an existing workspace (e.g. inside the API Harmonization server), run:
