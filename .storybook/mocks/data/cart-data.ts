...
const MOCK_CART = {
        ...
        data: [
            {
                ...
                sku: 'SKU-001',
                quantity: 2,
                price: { value: 49.99, currency: 'PLN' as const },
                subtotal: { value: 99.98, currency: 'PLN' as const },
                discountTotal: { value: 0, currency: 'PLN' as const },
                total: { value: 99.98, currency: 'PLN' as const },
                unit: 'PCS' as const,
                currency: 'PLN' as const,
                product: {
                    id: 'prod-1',
            ...
            },
            {
                ...
                sku: 'SKU-002',
                quantity: 1,
                price: { value: 105, currency: 'PLN' as const },
                subtotal: { value: 105, currency: 'PLN' as const },
                discountTotal: { value: 0, currency: 'PLN' as const },
                total: { value: 105, currency: 'PLN' as const },
                unit: 'PCS' as const,
                currency: 'PLN' as const,
                product: {
                    id: 'prod-2',
    ...
    subtotal: { value: 204.98, currency: 'PLN' as const },
    discountTotal: { value: 0, currency: 'PLN' as const },
    taxTotal: { value: 47.14, currency: 'PLN' as const },
    shippingTotal: { value: 0, currency: 'PLN' as const },
    total: { value: 252.12, currency: 'PLN' as const },
    billingAddress: {
        firstName: 'John',
        lastName: 'Doe',
...
const MOCK_EMPTY_CART = {
    ...
    subtotal: { value: 0, currency: 'PLN' as const },
    discountTotal: { value: 0, currency: 'PLN' as const },
    taxTotal: { value: 0, currency: 'PLN' as const },
    shippingTotal: { value: 0, currency: 'PLN' as const },
    total: { value: 0, currency: 'PLN' as const },
...
const MOCK_SHIPPING_OPTIONS = {
    data: [
        ...
        },
        {
            ...
            total: { value: 15, currency: 'PLN' as const },
            subtotal: { value: 15, currency: 'PLN' as const },
        },
    ],
    total: 2,
};
...
const MOCK_CHECKOUT_SUMMARY = {
    ...
    totals: {
        ...
        shipping: MOCK_CART.shippingTotal ?? { value: 0, currency: 'PLN' as const },
        tax: MOCK_CART.taxTotal ?? { value: 0, currency: 'PLN' as const },
        discount: MOCK_CART.discountTotal ?? { value: 0, currency: 'PLN' as const },
